#!/bin/bash
#############################################################################
# START_EXPERIMENT.sh - Experiment 2 Setup and Execution
# This script sets up the environment and runs Experiment 2 automatically
#############################################################################

set -e  # Exit on any error

echo "=========================================="
echo "🚀 Starting Experiment 2 Setup"
echo "=========================================="
echo ""
...
export DB_PATH="${DB_PATH:-exp2_results.db}"
export LOG_FILE="${LOG_FILE:-exp2_execution.log}"
export OUTPUT_DIR="${OUTPUT_DIR:-exp2_results}"

echo "=========================================="
echo "⚙️  Experiment 2 Configuration"
echo "=========================================="
echo "Trials:          $TRIALS"
...
echo "=========================================="
echo ""
echo "This will run experiment 2 with $TRIALS trials..."
